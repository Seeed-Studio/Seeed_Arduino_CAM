...
#define ESP_ERR_CAMERA_NOT_DETECTED             (ARDUINO_ERR_CAMERA_BASE + 1)
#define ESP_ERR_CAMERA_FAILED_TO_SET_FRAME_SIZE (ARDUINO_ERR_CAMERA_BASE + 2)
#define ESP_ERR_CAMERA_FAILED_TO_SET_OUT_FORMAT (ARDUINO_ERR_CAMERA_BASE + 3)
#define ESP_ERR_CAMERA_NOT_SUPPORTED            (ARDUINO_ERR_CAMERA_BASE + 4)
