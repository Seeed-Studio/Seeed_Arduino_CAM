// Copyright 2010-2020 CAMressif Systems (Shanghai) PTE LTD
//
 ...
 * @return
 *     - CAM_OK Success
 *     - CAM_ERR_INVALID_ARG Parameter error
 *     - CAM_ERR_NO_MEM No memory to initialize lcd_cam
 *     - CAM_FAIL Initialize fail
 */
